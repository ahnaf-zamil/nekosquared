...
class StringBookBinder(AbstractFactory[str, StringBooklet]):
    ...
    def with_respond_to_author_only(self,
                                    only_author=True) -> 'StringBookBinder':
    ...
    def with_page_number_formatter(self, formatter: FormatterType) \
            -> 'StringBookBinder':
        """
    ...
    def add_raw(self,
                ...
                *,
                to_start: bool = False,
                dont_alter: bool = False) -> 'StringBookBinder':
        """
    ...
    def add_line(self,
        ...
        """
        text = str(text) + '\n'
        self.add(text, to_start=to_start, empty_after=empty_after,
                 dont_alter=dont_alter)
        return self
