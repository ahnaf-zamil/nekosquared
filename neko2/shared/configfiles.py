...
def get_config_holder(file_name, *, deserializer=None):
    """
...
def get_config_data(file_name, *, deserializer=None):
    """Quickly fetches the config data synchronously."""
    return get_config_holder(file_name, deserializer=deserializer).sync_get()


async def get_config_data_async(file_name, *, deserializer=None):
    """Asynchronously reads config data from file."""
    holder = get_config_holder(file_name, deserializer=deserializer)
