...
_models = {
    UnitCollectionModel(
        ...
        UnitModel.new_cv('1000', 'kilometer', 'kilometers', 'kilometre',
                         'kilometres', 'km'),
        UnitModel.new_cv('1609.34', 'mile', 'miles', 'mi'),
        UnitModel.new_cv('0.9144', 'yard', 'yards', 'yd'),
        UnitModel.new_cv('0.0254', 'inch', 'inches', 'inchs', 'in'),
        UnitModel.new_cv('1852', 'nautical mile', 'nautical miles',
                         'nautical-mile', 'nautical-miles', 'nmi'),
        UnitModel.new_cv('0.01', 'centimeter', 'centimeters', 'centimetre',
                         'centimetres', 'cm'),
        UnitModel.new_cv('0.001', 'millimeter', 'millimeters', 'millimetre',
                         'millimetres', 'mm'),
